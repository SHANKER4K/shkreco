        ...
        {mode === 'adding' && captureStep === 1 && (
          <div style={{
            ...
            <input
              ...
              value={addingName}
              onChange={(e) => setAddingName(e.target.value.replace(/\s+/g, '_'))}
          ...
          <div style={{
            ...
            {captureStep === 2 && (
              <>
                ...
                {captureError && <p style={{ color: 'var(--red)', fontSize: 12, marginBottom: 12 }}>{captureError}</p>}
              </>
            )}
            {captureStep === 3 && (
              <p style={{ color: 'var(--green)', fontWeight: 500 }}>
                {captureError ? `Error: ${captureError}` : '✓ Employee registered successfully!'}
              </p>
            )}
          </div>
        )}
