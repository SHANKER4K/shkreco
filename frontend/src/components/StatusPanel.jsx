      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 4 }}>
            ...
            <span style={{ color: faceDetected ? 'var(--green)' : 'var(--red)', fontWeight: 500 }}>
        ...
        {lastRecognition ? (
          <div>
            ...
            <div style={{
              ...
              {lastRecognition.time} • {lastRecognition.confidence.toFixed(2)}
            </div>
            <div style={{
              display: 'inline-block',
              padding: '4px 10px',
              ...
              fontSize: 11,
              fontWeight: 500,
              background: lastRecognition.status === 'recognized' ? 'var(--green-dim)' : 'var(--red-dim)',
              color: lastRecognition.status === 'recognized' ? 'var(--green)' : 'var(--red)',
            }}>
              {lastRecognition.status}
            </div>
          </div>
        ) : (
          <div style={{ fontSize: 12, color: 'var(--text-2)' }}>No recognitions yet</div>
        )}
      </div>
